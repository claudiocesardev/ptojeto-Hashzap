...
# quando entrar no chat: (aparece para todo mundo)
    # menssagem que vc entrou no chat
    # o campo e o botao de enviar mensagem
# a cada menssagem que você envia (aparece para todo mundo)
...
def main(pagina):
    ...
    def entrar_popup(evento):
         ...
         pagina.remove(texto)
         #criar o campo de menssagem do usuario
         pagina.add(ft.Row(
            [campo_mensagem, botao_enviar_mensagem]
         ))
         # criar o botao de enviar menssagem do usuario
